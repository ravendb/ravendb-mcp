...
public static class ServerTools
{
    ...
    [McpServerTool(Name = "get_notifications", Title = "List notifications & alerts", ReadOnly = true)]
    ...
    [McpServerTool(Name = "get_server_config", Title = "View server configuration", ReadOnly = true)]
