...
{
    [McpServerTool(Name = "inspect_storage", Title = "Inspect storage engine (Voron)", ReadOnly = true)]
    ...
    [McpServerTool(Name = "get_server_resources", Title = "Inspect CPU, memory & I/O", ReadOnly = true)]
    ...
    [McpServerTool(Name = "get_network_details", Title = "Inspect network connections", ReadOnly = true)]
