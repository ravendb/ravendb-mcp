...
{
    [McpServerTool(Name = "sample_live_feed", Title = "Sample live diagnostics", ReadOnly = true, UseStructuredContent = true)]
    ...
    [McpServerTool(Name = "wait_for_completion", Title = "Wait for an operation or indexing", ReadOnly = true)]
